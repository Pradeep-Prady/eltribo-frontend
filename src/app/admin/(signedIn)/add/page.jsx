...
export default function Add() {
  ...
  const {
    mutate: addprod,
    isLoading: addprodLoading,
    isSuccess: addprodSuccess,
    error: addProdError,
    data: addProdData,
        ...
        <section className="w-full p-3 list-none">
          <form onSubmit={handleSubmit(Submit)}>
            <main className="flex outline-2 outline-red flex-col w-full px-4 py-3 bg-white rounded-lg mb-5">
              <div>
                ...
                <li className="mt-3 flex gap-4 mb-3">
                  {category.map((i, j) => (
                    <section
                      className={`max-h-[15rem] rounded-xl   border-2 w-[20rem] bg-[#f8fafc] flex flex-col items-center p-2 gap-3 ${
                        i._id === categorySelect
                          ? "border-[#2b71fe]"
                          : "border-[rgb(175,173,173)]"
                      }`}
                      key={j}
                      onClick={() => setCategorySelect(i._id)}
                    >
            ...
            <main className="flex flex-col w-full px-4 py-3 bg-white rounded-lg mt-4">
              ...
              {/* <li className="mt-3">
                <label className="text-[rgb(136,135,135)]">Slug</label>
                <br />
                <input
                  type="text"
                  className="w-full rounded-lg bg-[#f8fafc] border-[1px] border-[rgb(175,173,173)] mt-1 py-2 pl-3"
                  {...register("slug", { required: "Slug cannot be empty" })}
                />
