...
<li className={`flex-1 gap-[2rem] rounded-xl md:px-[2rem]   md:h-[550px] FCol justify-center ${rev ? 'order-2' : ''}`}>
		...
		<li className={`flex-1 ${rev ? 'order-1' : ''}`}>
			<ImageC src={'social/ElVentures.svg'} styles={'h-[400px] md:h-full w-full'} />
		</li>
