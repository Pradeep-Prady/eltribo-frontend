	...
	return (
		<Carousel responsive={responsive} autoPlay={true} infinite={true} autoPlaySpeed={3000}>
			<div className="relative">
				<ImageC src={'carousal/Carousal1.svg'} styles={'w-[1300px w-full h-[740px]'} />
				<Link href={'/products'}>
					<button className="absolute top-[67%] left-[3%] w-[200px] h-[60px]"></button>
				</Link>
			</div>
			<div className="relative">
				<ImageC src={'carousal/Carousal2.svg'} styles={'w-[1300px w-full h-[740px]'} />
				<Link href={'/products'}>
					<button className="absolute top-[60%] left-[2%] w-[180px] h-[60px]"></button>
				</Link>
			</div>
			<div className="relative">
				<ImageC src={'carousal/Carousal3.svg'} styles={'w-full h-[740px]'} />
				<Link href={'/products'}>
					<button className="absolute top-[84%] left-[44%] w-[180px] h-[60px]"></button>
				</Link>
			</div>
			<div className="relative">
				<ImageC src={'carousal/Carousal4.svg'} styles={'w-[1300px w-full h-[740px]'} />
				<Link href={'/products'}>
